...
#ifndef MODELIO_BINDINGS_SWIFT_H
#define MODELIO_BINDINGS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ModelIO_Bindings",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("ModelIO_Bindings", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
SWIFT_EXTERN void * _Nonnull $s16ModelIO_Bindings24createMDLVertexAttribute7namePtr9rawFormat6offset11bufferIndexSvSPys4Int8VG_SuS2itF(char const * _Nonnull namePtr, size_t rawFormat, ptrdiff_t offset, ptrdiff_t bufferIndex) SWIFT_NOEXCEPT SWIFT_CALL; // createMDLVertexAttribute(namePtr:rawFormat:offset:bufferIndex:)
SWIFT_EXTERN void * _Nonnull $s16ModelIO_Bindings25createMDLVertexDescriptorSvyF(void) SWIFT_NOEXCEPT SWIFT_CALL; // createMDLVertexDescriptor()
SWIFT_EXTERN void * _Nullable $s16ModelIO_Bindings13createMTKMesh10mdlMeshPtr06deviceH0SvSgSv_SvtF(void * _Nonnull mdlMeshPtr, void * _Nonnull devicePtr) SWIFT_NOEXCEPT SWIFT_CALL; // createMTKMesh(mdlMeshPtr:devicePtr:)
SWIFT_EXTERN void * _Nonnull $s16ModelIO_Bindings28createMTKMeshBufferAllocator9devicePtrS2v_tF(void * _Nonnull devicePtr) SWIFT_NOEXCEPT SWIFT_CALL; // createMTKMeshBufferAllocator(devicePtr:)
SWIFT_EXTERN void * _Nonnull $s16ModelIO_Bindings19createSphereMDLMesh19sphereWithExtentPtr08segmentsJ013inwardNormals15rawGeometryType09allocatorJ0SvSPySfG_SPys6UInt32VGSbSiSvtF(float const * _Nonnull sphereWithExtentPtr, uint32_t const * _Nonnull segmentsPtr, bool inwardNormals, ptrdiff_t rawGeometryType, void * _Nonnull allocatorPtr) SWIFT_NOEXCEPT SWIFT_CALL; // createSphereMDLMesh(sphereWithExtentPtr:segmentsPtr:inwardNormals:rawGeometryType:allocatorPtr:)
SWIFT_EXTERN void $s16ModelIO_Bindings18extractMeshBuffers03mtkE3Ptr0g6VertexfH007offsetsH0ySv_SpySvGSpySiGtF(void * _Nonnull mtkMeshPtr, void * _Nonnull * _Nonnull mtkVertexBuffersPtr, ptrdiff_t * _Nonnull offsetsPtr) SWIFT_NOEXCEPT SWIFT_CALL; // extractMeshBuffers(mtkMeshPtr:mtkVertexBuffersPtr:offsetsPtr:)
SWIFT_EXTERN void $s16ModelIO_Bindings26extractSubmeshIndexBuffers10mtkMeshPtr015submeshBufffersJ007offsetsJ0ySv_SpySvGSpySiGtF(void * _Nonnull mtkMeshPtr, void * _Nonnull * _Nonnull submeshBufffersPtr, ptrdiff_t * _Nonnull offsetsPtr) SWIFT_NOEXCEPT SWIFT_CALL; // extractSubmeshIndexBuffers(mtkMeshPtr:submeshBufffersPtr:offsetsPtr:)
SWIFT_EXTERN void $s16ModelIO_Bindings25extractSubmeshIndexCounts10mtkMeshPtr07submeshfG0ySv_SpySiGtF(void * _Nonnull mtkMeshPtr, ptrdiff_t * _Nonnull submeshIndexCounts) SWIFT_NOEXCEPT SWIFT_CALL; // extractSubmeshIndexCounts(mtkMeshPtr:submeshIndexCounts:)
SWIFT_EXTERN void $s16ModelIO_Bindings24extractSubmeshIndexTypes10mtkMeshPtr05indexgJ0ySv_SpySuGtF(void * _Nonnull mtkMeshPtr, size_t * _Nonnull indexTypesPtr) SWIFT_NOEXCEPT SWIFT_CALL; // extractSubmeshIndexTypes(mtkMeshPtr:indexTypesPtr:)
SWIFT_EXTERN void $s16ModelIO_Bindings28extractSubmeshPrimitiveTypes10mtkMeshPtr09primitivegJ0ySv_SpySuGtF(void * _Nonnull mtkMeshPtr, size_t * _Nonnull primitiveTypesPtr) SWIFT_NOEXCEPT SWIFT_CALL; // extractSubmeshPrimitiveTypes(mtkMeshPtr:primitiveTypesPtr:)
SWIFT_EXTERN ptrdiff_t $s16ModelIO_Bindings21getMTKMeshVertexCount10mdlMeshPtrSiSv_tF(void * _Nonnull mdlMeshPtr) SWIFT_NOEXCEPT SWIFT_CALL; // getMTKMeshVertexCount(mdlMeshPtr:)
SWIFT_EXTERN void $s16ModelIO_Bindings14releaseMDLMesh10mdlMeshPtrySv_tF(void * _Nonnull mdlMeshPtr) SWIFT_NOEXCEPT SWIFT_CALL; // releaseMDLMesh(mdlMeshPtr:)
SWIFT_EXTERN void $s16ModelIO_Bindings25releaseMDLVertexAttribute09mdlVertexF3PtrySv_tF(void * _Nonnull mdlVertexAttributePtr) SWIFT_NOEXCEPT SWIFT_CALL; // releaseMDLVertexAttribute(mdlVertexAttributePtr:)
SWIFT_EXTERN void $s16ModelIO_Bindings26releaseMDLVertexDescriptor09mdlVertexF0ySv_tF(void * _Nonnull mdlVertexDescriptor) SWIFT_NOEXCEPT SWIFT_CALL; // releaseMDLVertexDescriptor(mdlVertexDescriptor:)
SWIFT_EXTERN void $s16ModelIO_Bindings14releaseMTKMesh10mtkMeshPtrySv_tF(void * _Nonnull mtkMeshPtr) SWIFT_NOEXCEPT SWIFT_CALL; // releaseMTKMesh(mtkMeshPtr:)
SWIFT_EXTERN void $s16ModelIO_Bindings29releaseMTKMeshBufferAllocator07mtkMeshfG3PtrySv_tF(void * _Nonnull mtkMeshBufferAllocatorPtr) SWIFT_NOEXCEPT SWIFT_CALL; // releaseMTKMeshBufferAllocator(mtkMeshBufferAllocatorPtr:)
SWIFT_EXTERN void $s16ModelIO_Bindings26setMDLMeshVertexDescriptor10mdlMeshPtr0hfgJ0ySv_SvtF(void * _Nonnull mdlMeshPtr, void * _Nonnull mdlVertexDescriptorPtr) SWIFT_NOEXCEPT SWIFT_CALL; // setMDLMeshVertexDescriptor(mdlMeshPtr:mdlVertexDescriptorPtr:)
SWIFT_EXTERN void $s16ModelIO_Bindings31setMDLVertexDescriptorAttribute09mdlVertexF3Ptr5index0higJ0ySv_SiSvtF(void * _Nonnull mdlVertexDescriptorPtr, ptrdiff_t index, void * _Nonnull mdlVertexAttributePtr) SWIFT_NOEXCEPT SWIFT_CALL; // setMDLVertexDescriptorAttribute(mdlVertexDescriptorPtr:index:mdlVertexAttributePtr:)
SWIFT_EXTERN void $s16ModelIO_Bindings18setMDLVertexLayout22mdlVertexDescriptorPtr5index6strideySv_S2itF(void * _Nonnull mdlVertexDescriptorPtr, ptrdiff_t index, ptrdiff_t stride) SWIFT_NOEXCEPT SWIFT_CALL; // setMDLVertexLayout(mdlVertexDescriptorPtr:index:stride:)
...
SWIFT_INLINE_THUNK swift::Int countSubmeshes(void * _Nonnull mtkMeshPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings14countSubmeshes10mtkMeshPtrSiSv_tF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::$s16ModelIO_Bindings14countSubmeshes10mtkMeshPtrSiSv_tF(mtkMeshPtr);
}


SWIFT_INLINE_THUNK swift::Int countVertexBuffers(void * _Nonnull mtkMeshPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings18countVertexBuffers10mtkMeshPtrSiSv_tF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::$s16ModelIO_Bindings18countVertexBuffers10mtkMeshPtrSiSv_tF(mtkMeshPtr);
}


SWIFT_INLINE_THUNK void * _Nonnull createBoxMDLMesh(float const * _Nonnull boxWithExtentPtr, uint32_t const * _Nonnull segmentsPtr, bool inwardNormals, swift::Int rawGeometryType, void * _Nonnull allocatorPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings16createBoxMDLMesh16boxWithExtentPtr08segmentsJ013inwardNormals15rawGeometryType09allocatorJ0SvSPySfG_SPys6UInt32VGSbSiSvtF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::$s16ModelIO_Bindings16createBoxMDLMesh16boxWithExtentPtr08segmentsJ013inwardNormals15rawGeometryType09allocatorJ0SvSPySfG_SPys6UInt32VGSbSiSvtF(boxWithExtentPtr, segmentsPtr, inwardNormals, rawGeometryType, allocatorPtr);
}


SWIFT_INLINE_THUNK void * _Nonnull createMDLVertexAttribute(char const * _Nonnull namePtr, swift::UInt rawFormat, swift::Int offset, swift::Int bufferIndex) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings24createMDLVertexAttribute7namePtr9rawFormat6offset11bufferIndexSvSPys4Int8VG_SuS2itF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::$s16ModelIO_Bindings24createMDLVertexAttribute7namePtr9rawFormat6offset11bufferIndexSvSPys4Int8VG_SuS2itF(namePtr, rawFormat, offset, bufferIndex);
}


SWIFT_INLINE_THUNK void * _Nonnull createMDLVertexDescriptor() noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings25createMDLVertexDescriptorSvyF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::$s16ModelIO_Bindings25createMDLVertexDescriptorSvyF();
}


SWIFT_INLINE_THUNK void * _Nullable createMTKMesh(void * _Nonnull mdlMeshPtr, void * _Nonnull devicePtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings13createMTKMesh10mdlMeshPtr06deviceH0SvSgSv_SvtF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::$s16ModelIO_Bindings13createMTKMesh10mdlMeshPtr06deviceH0SvSgSv_SvtF(mdlMeshPtr, devicePtr);
}


SWIFT_INLINE_THUNK void * _Nonnull createMTKMeshBufferAllocator(void * _Nonnull devicePtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings28createMTKMeshBufferAllocator9devicePtrS2v_tF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::$s16ModelIO_Bindings28createMTKMeshBufferAllocator9devicePtrS2v_tF(devicePtr);
}


SWIFT_INLINE_THUNK void * _Nonnull createSphereMDLMesh(float const * _Nonnull sphereWithExtentPtr, uint32_t const * _Nonnull segmentsPtr, bool inwardNormals, swift::Int rawGeometryType, void * _Nonnull allocatorPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings19createSphereMDLMesh19sphereWithExtentPtr08segmentsJ013inwardNormals15rawGeometryType09allocatorJ0SvSPySfG_SPys6UInt32VGSbSiSvtF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::$s16ModelIO_Bindings19createSphereMDLMesh19sphereWithExtentPtr08segmentsJ013inwardNormals15rawGeometryType09allocatorJ0SvSPySfG_SPys6UInt32VGSbSiSvtF(sphereWithExtentPtr, segmentsPtr, inwardNormals, rawGeometryType, allocatorPtr);
}


SWIFT_INLINE_THUNK void extractMeshBuffers(void * _Nonnull mtkMeshPtr, void * _Nonnull * _Nonnull mtkVertexBuffersPtr, swift::Int * _Nonnull offsetsPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings18extractMeshBuffers03mtkE3Ptr0g6VertexfH007offsetsH0ySv_SpySvGSpySiGtF") {
  _impl::$s16ModelIO_Bindings18extractMeshBuffers03mtkE3Ptr0g6VertexfH007offsetsH0ySv_SpySvGSpySiGtF(mtkMeshPtr, mtkVertexBuffersPtr, offsetsPtr);
}


SWIFT_INLINE_THUNK void extractSubmeshIndexBuffers(void * _Nonnull mtkMeshPtr, void * _Nonnull * _Nonnull submeshBufffersPtr, swift::Int * _Nonnull offsetsPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings26extractSubmeshIndexBuffers10mtkMeshPtr015submeshBufffersJ007offsetsJ0ySv_SpySvGSpySiGtF") {
  _impl::$s16ModelIO_Bindings26extractSubmeshIndexBuffers10mtkMeshPtr015submeshBufffersJ007offsetsJ0ySv_SpySvGSpySiGtF(mtkMeshPtr, submeshBufffersPtr, offsetsPtr);
}


SWIFT_INLINE_THUNK void extractSubmeshIndexCounts(void * _Nonnull mtkMeshPtr, swift::Int * _Nonnull submeshIndexCounts) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings25extractSubmeshIndexCounts10mtkMeshPtr07submeshfG0ySv_SpySiGtF") {
  _impl::$s16ModelIO_Bindings25extractSubmeshIndexCounts10mtkMeshPtr07submeshfG0ySv_SpySiGtF(mtkMeshPtr, submeshIndexCounts);
}


SWIFT_INLINE_THUNK void extractSubmeshIndexTypes(void * _Nonnull mtkMeshPtr, swift::UInt * _Nonnull indexTypesPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings24extractSubmeshIndexTypes10mtkMeshPtr05indexgJ0ySv_SpySuGtF") {
  _impl::$s16ModelIO_Bindings24extractSubmeshIndexTypes10mtkMeshPtr05indexgJ0ySv_SpySuGtF(mtkMeshPtr, indexTypesPtr);
}


SWIFT_INLINE_THUNK void extractSubmeshPrimitiveTypes(void * _Nonnull mtkMeshPtr, swift::UInt * _Nonnull primitiveTypesPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings28extractSubmeshPrimitiveTypes10mtkMeshPtr09primitivegJ0ySv_SpySuGtF") {
  _impl::$s16ModelIO_Bindings28extractSubmeshPrimitiveTypes10mtkMeshPtr09primitivegJ0ySv_SpySuGtF(mtkMeshPtr, primitiveTypesPtr);
}


SWIFT_INLINE_THUNK swift::Int getMTKMeshVertexCount(void * _Nonnull mdlMeshPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings21getMTKMeshVertexCount10mdlMeshPtrSiSv_tF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::$s16ModelIO_Bindings21getMTKMeshVertexCount10mdlMeshPtrSiSv_tF(mdlMeshPtr);
}


SWIFT_INLINE_THUNK void releaseMDLMesh(void * _Nonnull mdlMeshPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings14releaseMDLMesh10mdlMeshPtrySv_tF") {
  _impl::$s16ModelIO_Bindings14releaseMDLMesh10mdlMeshPtrySv_tF(mdlMeshPtr);
}


SWIFT_INLINE_THUNK void releaseMDLVertexAttribute(void * _Nonnull mdlVertexAttributePtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings25releaseMDLVertexAttribute09mdlVertexF3PtrySv_tF") {
  _impl::$s16ModelIO_Bindings25releaseMDLVertexAttribute09mdlVertexF3PtrySv_tF(mdlVertexAttributePtr);
}


SWIFT_INLINE_THUNK void releaseMDLVertexDescriptor(void * _Nonnull mdlVertexDescriptor) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings26releaseMDLVertexDescriptor09mdlVertexF0ySv_tF") {
  _impl::$s16ModelIO_Bindings26releaseMDLVertexDescriptor09mdlVertexF0ySv_tF(mdlVertexDescriptor);
}


SWIFT_INLINE_THUNK void releaseMTKMesh(void * _Nonnull mtkMeshPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings14releaseMTKMesh10mtkMeshPtrySv_tF") {
  _impl::$s16ModelIO_Bindings14releaseMTKMesh10mtkMeshPtrySv_tF(mtkMeshPtr);
}


SWIFT_INLINE_THUNK void releaseMTKMeshBufferAllocator(void * _Nonnull mtkMeshBufferAllocatorPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings29releaseMTKMeshBufferAllocator07mtkMeshfG3PtrySv_tF") {
  _impl::$s16ModelIO_Bindings29releaseMTKMeshBufferAllocator07mtkMeshfG3PtrySv_tF(mtkMeshBufferAllocatorPtr);
}


SWIFT_INLINE_THUNK void setMDLMeshVertexDescriptor(void * _Nonnull mdlMeshPtr, void * _Nonnull mdlVertexDescriptorPtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings26setMDLMeshVertexDescriptor10mdlMeshPtr0hfgJ0ySv_SvtF") {
  _impl::$s16ModelIO_Bindings26setMDLMeshVertexDescriptor10mdlMeshPtr0hfgJ0ySv_SvtF(mdlMeshPtr, mdlVertexDescriptorPtr);
}


SWIFT_INLINE_THUNK void setMDLVertexDescriptorAttribute(void * _Nonnull mdlVertexDescriptorPtr, swift::Int index, void * _Nonnull mdlVertexAttributePtr) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings31setMDLVertexDescriptorAttribute09mdlVertexF3Ptr5index0higJ0ySv_SiSvtF") {
  _impl::$s16ModelIO_Bindings31setMDLVertexDescriptorAttribute09mdlVertexF3Ptr5index0higJ0ySv_SiSvtF(mdlVertexDescriptorPtr, index, mdlVertexAttributePtr);
}


SWIFT_INLINE_THUNK void setMDLVertexLayout(void * _Nonnull mdlVertexDescriptorPtr, swift::Int index, swift::Int stride) noexcept SWIFT_SYMBOL("s:16ModelIO_Bindings18setMDLVertexLayout22mdlVertexDescriptorPtr5index6strideySv_S2itF") {
  _impl::$s16ModelIO_Bindings18setMDLVertexLayout22mdlVertexDescriptorPtr5index6strideySv_S2itF(mdlVertexDescriptorPtr, index, stride);
}


} // namespace ModelIO_Bindings
