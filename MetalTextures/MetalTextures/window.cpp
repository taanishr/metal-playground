...
void AppDelegate::applicationDidFinishLaunching(NS::Notification* notification)
{
    ...
    m_mtkView->setClearColor(MTL::ClearColor::Make(0.733,0.969,0.815,1));
    
    m_mtkView->setDepthStencilPixelFormat(MTL::PixelFormat::PixelFormatDepth32Float);
    ...
    m_window->setTitle(NS::String::string("spooky", NS::StringEncoding::UTF8StringEncoding ));
//
